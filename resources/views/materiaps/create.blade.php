...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Crear materia prima</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            {!! Form::open(array('route'=>'materiaps.storesi', 'method'=>'POST'))!!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        {{-- {!! Form::select('proveedor_id', $proveedors, array('class'=>'form-control'))!!} --}}
                                        {!! Form::select('proveedor_id', $proveedors,null, ['placeholder'=>'Seleccione un proveedor','class'=>'form-control'])!!}
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('area_id', $areas,null, ['placeholder'=>'Seleccione un area','class'=>'form-control'])!!}
