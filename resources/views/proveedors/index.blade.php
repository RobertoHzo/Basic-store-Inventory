            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @can('crear-proveedor')
                        <a href="{{ route('proveedors.create') }}" class="btn btn-warning">Nuevo Proveedor</a>
                        @endcan
                        <br>
                        <br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info" href="{{ route('proveedors.edit', $proveedor->id) }}"><i class="fas fa-edit"></i></a>
                                            @endcan
                                            @can('eliminar-proveedor')
                                            {!! Form::open(['method'=> 'DELETE', 'route'=> ['proveedors.destroy', $proveedor->id], 'style'=>'display: inline', 'class'=>'formEliminar',]) !!}
        ...
        (function () {
            ...
            .forEach(function (form) {
                form.addEventListener('submit', function (event) {
                    ...
                    Swal.fire({
                        title: '¿Confirma la eliminación del proveedor?',
                        icon: 'info',
